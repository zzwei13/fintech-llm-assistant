...
from llama_flask.app.services.get_prompt_data import *
from llama_flask.app.services.prompt_generater import *
...
async def predict_single_stock(stock_id):
    ...
    GM_values = [
        safe_get_value(data_GM, year, "GM") for year in range(start_year, end_year + 1)
    ]
    OPM_values = [
